...
Public Class iffWaybillITR002
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "iffWinApp64.iffWaybillITR002.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachediffWaybillITR002
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As iffWaybillITR002 = New iffWaybillITR002()
        rpt.Site = Me.Site
        Return rpt
    End Function
