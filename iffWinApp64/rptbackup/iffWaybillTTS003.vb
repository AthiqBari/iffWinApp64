...
Public Class iffWaybillTTS003
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "iffWinApp64.iffWaybillTTS003.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachediffWaybillTTS003
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As iffWaybillTTS003 = New iffWaybillTTS003()
        rpt.Site = Me.Site
        Return rpt
    End Function
