...
Public Class iffWBListBySalesRev
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "iffWBListBySalesRev.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "iffWinApp64.iffWBListBySalesRev.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachediffWBListBySalesRev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As iffWBListBySalesRev = New iffWBListBySalesRev()
        rpt.Site = Me.Site
        Return rpt
    End Function
