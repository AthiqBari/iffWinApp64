...
Public Class iffWaybillTTS004
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "iffWinApp64.iffWaybillTTS004.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paramValue1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachediffWaybillTTS004
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As iffWaybillTTS004 = New iffWaybillTTS004()
        rpt.Site = Me.Site
        Return rpt
    End Function
